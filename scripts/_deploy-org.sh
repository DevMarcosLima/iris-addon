...
if [[ "$CRON_ONLY" == "true" ]]; then
  ...
  # CLOUD RUN
  log_filter+=('OR "run.namespace.create" OR "run.namespace.get" OR "run.namespace.list" OR "run.namespace.update"')
  log_filter+=('OR "run.services.create" OR "run.services.get" OR "run.services.list" OR "run.services.update"')
  log_filter+=('OR "run.routes.create" OR "run.routes.get" OR "run.routes.list" OR "run.routes.update"')
